...
int main(void)
{
	...
	do {		
		printf("podaj ilosc dni miesiaca (31,30,29,28): \n");
		if(scanf("%d", &m)==1) 
		{
			if (m >= 28 && m <= 31) 
			{
				do 
				{
					printf("podaj pierwszy dzien tygodnia: (1-PN, 7-ND)\n");
					scanf("%d", &d);
					dzienOK = d>0 && d<8;
					...
					if (dzienOK) 
					{
						...
						printf("\n");
						printf("Nacicnij dowolny klawisz aby kontynuowac lub x aby zakonnzyc");
						printf("\n");
